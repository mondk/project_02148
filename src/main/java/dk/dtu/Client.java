	...
	public static void main(String[] args) {
		...
		try {
			...
			while(true) {
				...
				try {
					Object[] t = chat.getp(new FormalField(String.class), new FormalField(String.class),new FormalField(String.class));
					if(t!=null) {
						if(name.equals((String)t[0])) {
							System.out.println("Me: " + t[1]);
						}
						else {
